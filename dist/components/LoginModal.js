...
var LoginModal = function (_a) {
    ...
    var handleConnect = function (method) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, onConnect(method)];
                case 1:
                    _a.sent();
                    onClose();
                    return [3 /*break*/, 3];
    ...
    return (react_1.default.createElement("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50", onClick: onClose },
        react_1.default.createElement("div", { className: "bg-white p-6 rounded-lg w-[400px] max-w-[90%]", onClick: function (e) { return e.stopPropagation(); } },
            react_1.default.createElement("h2", { className: "text-xl font-bold mb-4" }, "Connect Your Wallet"),
            enabledMethods.map(function (method) { return (react_1.default.createElement("button", { key: method, onClick: function () { return handleConnect(method); }, className: "w-full py-3 px-4 mb-2 border border-blue-500 rounded-lg hover:bg-blue-50 flex items-center justify-center gap-2" }, method.charAt(0).toUpperCase() + method.slice(1))); }))));
};
